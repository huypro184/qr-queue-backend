...
const { createNewAdmin, createNewStaff, getUsers, deleteUser, updateUser } = require('../controllers/userController');
...
router.patch('/:userId', protect, restrictTo('superadmin', 'admin'), updateUser);
